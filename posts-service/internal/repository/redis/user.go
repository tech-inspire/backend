...
func NewPostRepository(client redis.UniversalClient, cfg *config.Config) *PostsRepository {
...
func (r *PostsRepository) key(postID uuid.UUID) string {
...
func (r *PostsRepository) GetPostsByIDs(ctx context.Context, PostIDs []uuid.UUID) (*GetPostsByIDsOutput, error) {
...
func (r *PostsRepository) SetPostByID(ctx context.Context, post *models.Post) error {
...
func (r *PostsRepository) SetPosts(ctx context.Context, posts []*models.Post) error {
